...
The file is then processed with python's NLTK library. The module analyse.py creates Text objects for each file and performs a simple tokenizing process to retrieve the unique word counts for each artist. Both .py files require python3.
